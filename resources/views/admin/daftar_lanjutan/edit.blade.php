...
{{-- {{ $daftarLanjutan->pendaftar->asal_sekolah }} --}}
{{-- {{ optional($daftarLanjutan->pendaftar)->asal_sekolah }} --}}
<!DOCTYPE html>
<html lang="id">
                ...
                <form action="{{ route('admin.daftar-lanjutan.update', $daftarLanjutan->id) }}" method="POST">
                    ...
                    <div class="grid2">
                        <div class="field">
                            ...
                            <input type="text" value="{{ optional($daftarLanjutan->pendaftar)->nama_lengkap }}">
                        </div>
                        <div class="field">
                            <label>NISN</label>
                            <input type="text" value="{{ optional($daftarLanjutan->pendaftar)->nisn }}">
                        </div>
                        <div class="field">
                            <label>No. HP</label>
                            <input type="text" value="{{ optional($daftarLanjutan->pendaftar)->no_hp }}">
                        </div>
                        <div class="field">
                            <label>Asal Sekolah</label>
                            <input type="text" value="{{ optional($daftarLanjutan->pendaftar)->asal_sekolah }}">
                        </div>
                        <div class="field">
                            <label>Jurusan</label>
                            <input type="text" value="{{ optional($daftarLanjutan->pendaftar)->jurusan }}">
                        </div>
                        <div class="field">
                            <label>Status</label>
                            <input type="text" value="{{ optional($daftarLanjutan->pendaftar)->status }}">
                        </div>
                    </div>
                    ...
                    <div class="grid2">
                        <div class="field">
                            ...
                            <select name="jalur_pendaftaran">
                                @foreach (['Afirmasi', 'Prestasi', 'Reguler'] as $j)
                                    <option value="{{ $j }}"
                                        {{ $daftarLanjutan->jalur_pendaftaran == $j ? 'selected' : '' }}>
                                        {{ $j }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="field">
                            ...
                            <select name="jenis_kelamin">
                                @foreach (['Laki-laki', 'Perempuan'] as $jk)
                                    <option value="{{ $jk }}"
                                        {{ $daftarLanjutan->jenis_kelamin == $jk ? 'selected' : '' }}>
                                        {{ $jk }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="field">
                            ...
                            <input type="date" name="tanggal_lahir"
                                value="{{ $daftarLanjutan->tanggal_lahir ? \Carbon\Carbon::parse($daftarLanjutan->tanggal_lahir)->format('Y-m-d') : '' }}">
                        </div>
                        <div class="field">
                            <label>Agama</label>
                    ...
                    <div class="grid3">
                        ...
                        <div class="field">
                            ...
                            <input type="text" name="tahun_lahir_ayah"
                                value="{{ $daftarLanjutan->tahun_lahir_ayah }}">
                        </div>
                        <div class="field">
                        ...
                        <div class="field">
                            ...
                            <select name="pendidikan_ayah">
                                ...
                                @foreach (['Tidak Sekolah', 'Putus SD', 'SD Sederajat', 'SMP Sederajat', 'SMA Sederajat', 'D1', 'D2', 'D3', 'D4/S1', 'S2', 'S3'] as $p)
                                    <option value="{{ $p }}"
                                        {{ $daftarLanjutan->pendidikan_ayah == $p ? 'selected' : '' }}>
                                        {{ $p }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="field">
                            ...
                            <select name="penghasilan_ayah">
                                ...
                                @foreach (['Tidak Berpenghasilan', 'Kurang Dari 1.000.000', '1.000.000-2.000.000', 'Lebih Dari 3.000.000'] as $p)
                                    <option value="{{ $p }}"
                                        {{ $daftarLanjutan->penghasilan_ayah == $p ? 'selected' : '' }}>
                                        {{ $p }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="field">
                            ...
                            <input type="text" name="tahun_lahir_ibu"
                                value="{{ $daftarLanjutan->tahun_lahir_ibu }}">
                        </div>
                        <div class="field">
                        ...
                        <div class="field">
                            ...
                            <select name="pendidikan_ibu">
                                ...
                                @foreach (['Tidak Sekolah', 'Putus SD', 'SD Sederajat', 'SMP Sederajat', 'SMA Sederajat', 'D1', 'D2', 'D3', 'D4/S1', 'S2', 'S3'] as $p)
                                    <option value="{{ $p }}"
                                        {{ $daftarLanjutan->pendidikan_ibu == $p ? 'selected' : '' }}>
                                        {{ $p }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="field">
                            ...
                            <select name="penghasilan_ibu">
                                ...
                                @foreach (['Tidak Berpenghasilan', 'Kurang Dari 1.000.000', '1.000.000-2.000.000', 'Lebih Dari 3.000.000'] as $p)
                                    <option value="{{ $p }}"
                                        {{ $daftarLanjutan->penghasilan_ibu == $p ? 'selected' : '' }}>
                                        {{ $p }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="field">
                            ...
                            <select name="pendidikan_wali">
                                ...
                                @foreach (['Tidak Sekolah', 'Putus SD', 'SD Sederajat', 'SMP Sederajat', 'SMA Sederajat', 'D1', 'D2', 'D3', 'D4/S1', 'S2', 'S3'] as $p)
                                    <option value="{{ $p }}"
                                        {{ $daftarLanjutan->pendidikan_wali == $p ? 'selected' : '' }}>
                                        {{ $p }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="field">
                            ...
                            <select name="penghasilan_wali">
                                ...
                                @foreach (['Tidak Berpenghasilan', 'Kurang Dari 1.000.000', '1.000.000-2.000.000', 'Lebih Dari 3.000.000'] as $p)
                                    <option value="{{ $p }}"
                                        {{ $daftarLanjutan->penghasilan_wali == $p ? 'selected' : '' }}>
                                        {{ $p }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="field">
                            ...
                            <select name="jenis_tinggal">
                                ...
                                @foreach (['Bersama Orang Tua', 'Wali', 'Kost', 'Asrama/Pesantren', 'Panti Asuhan'] as $jt)
                                    <option value="{{ $jt }}"
                                        {{ $daftarLanjutan->jenis_tinggal == $jt ? 'selected' : '' }}>
                                        {{ $jt }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="grid3">
                        ...
                        <div class="field">
                            ...
                            <input type="text" name="ukuran_pakaian"
                                value="{{ $daftarLanjutan->ukuran_pakaian }}">
                        </div>
                        <div class="field">
                        ...
                        <div class="field">
                            ...
                            <input type="text" name="berkebutuhan_khusus"
                                value="{{ $daftarLanjutan->berkebutuhan_khusus }}">
                        </div>
                        <div class="field">
                        ...
                        <div class="field">
                            ...
                            <input type="text" name="jarak_ke_sekolah"
                                value="{{ $daftarLanjutan->jarak_ke_sekolah }}">
                        </div>
                        <div class="field">
                            ...
                            <select name="alat_transportasi">
                                ...
                                @foreach (['Jalan Kaki', 'Kendaraan Pribadi', 'Kendaraan Umum', 'Jemputan', 'Ojek', 'Di Antarkan'] as $at)
                                    <option value="{{ $at }}"
                                        {{ $daftarLanjutan->alat_transportasi == $at ? 'selected' : '' }}>
                                        {{ $at }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="field">
                            ...
                            <input type="text" name="jumlah_saudara"
                                value="{{ $daftarLanjutan->jumlah_saudara }}">
                        </div>
                        <div class="field">
                            <label>Memiliki KIP?</label>
                            <select name="memiliki_kip">
                                <option value="0" {{ $daftarLanjutan->memiliki_kip == 0 ? 'selected' : '' }}>
                                    Tidak</option>
                                <option value="1" {{ $daftarLanjutan->memiliki_kip == 1 ? 'selected' : '' }}>Ya
                                </option>
                            </select>
                        </div>
                        <div class="field">
                    ...
                    <div class="grid2">
                        ...
                        <div class="field">
                            ...
                            <input type="text" name="dari_mana_mengenal"
                                value="{{ $daftarLanjutan->dari_mana_mengenal }}">
                        </div>
                        <div class="field full">
